...
| --- | --- | --- | --- | ---| 
| 20210719T01:56:08Z | An open-source Chinese font derived from Fontworks% Klee One. 一款基于 FONTWORKS 的 Klee One 的开源中文字体。 | https://github.com/lxgw/LxgwWenKai | 1201 | 26| 
...
| ts | title | url | stars | forks| 
| --- | --- | --- | --- | ---| 
| 20210719T01:57:38Z | A malicious JavaScript script that exploit XSS vulnerabilities in a modern way using steganography technique and Telegram. | https://github.com/Naqwa/SnitchyScript | 0 | 0| 
| 20210719T01:52:49Z | CommandAndControlServer for post exploitation.  | https://github.com/RyanMower/CommandAndControlServer | 0 | 0| 
...
| ts | title | url | stars | forks| 
| --- | --- | --- | --- | ---| 
| 20210719T01:50:45Z | Small collection of bash scripts that take advantage of the .bashrc file and inject various payloads into it in order to escalate privileges or steal credentials. | https://github.com/Naqwa/Bashrc-Backdoors | 0 | 0| 
