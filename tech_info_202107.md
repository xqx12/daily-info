...
| ts | title | url | stars | forks| 
| --- | --- | --- | --- | ---| 
| 20210706T01:32:23Z | Hello, this is a write-up for a form of a ret2libc ROP attack, which is used to bypass a exploit mitigation, known as NX for linux and DEP for windows. | https://github.com/Ret2plt/Ret2libc-Exploit-Write-up | 0 | 0| 
