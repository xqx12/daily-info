...
| ts | title | url | stars | forks| 
| --- | --- | --- | --- | ---| 
| 20210724T00:28:23Z | A small application to extract @Route annotations from PHP code and generate a Swagger / OpenAPI specification after that | https://github.com/JuKu/php-route-extractor-fuzzer | 0 | 0| 
