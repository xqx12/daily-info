...
| ts | title | url | stars | forks| 
| --- | --- | --- | --- | ---| 
| 20210719T01:47:46Z | Small collection of bash scripts that take advantage of the .bashrc file and inject various payloads into it in order to escalate privileges or steal credentials. | https://github.com/Naqwa/Bashrc-Backdoors | 0 | 0| 
