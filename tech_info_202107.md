...
| --- | --- | --- | --- | ---| 
| 20210719T01:45:43Z | An open-source Chinese font derived from Fontworks% Klee One. 一款基于 FONTWORKS 的 Klee One 的开源中文字体。 | https://github.com/lxgw/LxgwWenKai | 1196 | 26| 
...
| ts | title | url | stars | forks| 
| --- | --- | --- | --- | ---| 
| 20210719T01:49:14Z | Small collection of bash scripts that take advantage of the .bashrc file and inject various payloads into it in order to escalate privileges or steal credentials. | https://github.com/Naqwa/Bashrc-Backdoors | 0 | 0| 
