...
| --- | --- | --- | --- | ---| 
| 20210708T00:58:10Z | CVE-2020-1956 | CVE-2020-1956 | https://github.com/b510/CVE-2020-1956 | Apache Kylin 2.3.0, and releases up to 2.6.5 and 3.0.1 has some restful apis which will concatenate os command with the user input string, a user is likely to be able to execute any os command without any protection or validation.| 
...
| ts | title | url | stars | forks| 
| --- | --- | --- | --- | ---| 
| 20210708T00:58:39Z | ShiroExploit 是一款 Shiro 可视化利用工具，集成密钥爆破，命令回显内存马注入等功能 | https://github.com/KpLi0rn/ShiroExploit | 31 | 0| 
