...
| ts | title | url | stars | forks| 
| --- | --- | --- | --- | ---| 
| 20201111T02:07:44Z | To turn the exploration of graph genomes into an immersive, interactive, and usable iVR experience, we built a new VR application which we call %The Immersive Graph Genome Explorer% (IGGE). IGGE is a virtual platform built upon the Unity Game Engine that affords a suite of graph genome exploitation tools, cross-platform viewing, and 3DUI. | https://github.com/immersivegraphgenomeexplorer/IGGE | 0 | 0| 
