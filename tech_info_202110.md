...
| ts | title | url| 
| --- | --- | ---| 
| 20211015 | Chrome 浏览器 Windows 版本的实现架构文档 | https://chromium.googlesource.com/chromium/src/+/refs/heads/main/docs/design/sandbox.md| 
| 20211015 | Finger - IDA 插件，用于在指定的二进制文件中识别未命名的库函数 | https://github.com/aliyunav/Finger| 
| 20211015 | VirusTotal 发布的《2021 勒索软件活动分析报告》 | https://storage.googleapis.com/vtpublic/vt-ransomware-report-2021.pdf| 
| 20211015 | nt!ObpCreateSymbolicLinkName 没有正确加锁导致的内核条件竞争任意地址写漏洞 | https://pastebin.com/H7tQSX7C| 
| 20211015 | Sysmon For Linux 发布了 | https://github.com/Sysinternals/SysmonForLinux| 
| 20211015 | Issue 2201: WebKit: heap-use-after-free in EventHandler::keyEvent | https://bugs.chromium.org/p/project-zero/issues/detail?id=2201| 
| 20211015 | 基于 Xen 和 AFL 实现的内核 Fuzzer，利用 Xen VM forks 实现 AFL 多实例并行支持，利用 Intel PT 实现 Coverage 收集 | https://github.com/intel/kernel-fuzzer-for-xen-project| 
| 20211015 | StateAFL - 基于 AFL 实现的用于 Fuzz 网络服务器的 Fuzzer | https://github.com/stateafl/stateafl| 
| 20211015 | Apple 发了一份关于 App Sideloading 威胁的报告，App Sideloading 指绕过官方 App Store 安装 App | https://www.apple.com/privacy/docs/Building_a_Trusted_Ecosystem_for_Millions_of_Apps_A_Threat_Analysis_of_Sideloading.pdf| 
...
| 20211013 | Broadcom SDK UPnP 实现存在多个安全漏洞，影响 Cisco, DD-WRT, Linksys 厂商的多款设备 | http://www.iot-inspector.com/blog/broadcom-sdk-vulnerabilities-bug-reports/| 
| 20211013 | Bypassing required reviews using GitHub Actions | https://medium.com/cider-sec/bypassing-required-reviews-using-github-actions-6e1b29135cc7| 
| 20211013 | 自动监控及报警系统 Prometheus 被发现存在大量的公开 Endpoints，存在敏感信息泄露 | https://jfrog.com/blog/dont-let-prometheus-steal-your-fire/| 
...
| ts | title | url | stars | forks| 
| --- | --- | --- | --- | ---| 
| 20211015T12:00:42Z | PS4 Jailbreak by Karo and Re Designed by Me For Firmware 672 | https://github.com/Harleythetech/Exploit-6.72 | 0 | 0| 
...
| 20211015T11:02:55Z | Open-Source Vulnerability Intelligence Center - Unified source of vulnerability, exploit and threat Intelligence feeds | https://github.com/Patrowl/PatrowlHearsData | 32 | 19| 
...
| 20211014T14:15:36Z | pybotnet -   A Python Library for building Botnet , Trojan or BackDoor for windows and linux with Telegram control panel  | https://github.com/onionj/pybotnet | 34 | 18| 
...
| 20211013T18:26:00Z | A penetration testing tool for finding file upload bugs (NDSS 2020) | https://github.com/WSP-LAB/FUSE | 188 | 43| 
