...
| 20210724T12:33:49Z | PoC for exploiting CVE-2020-14409 : SDL (Simple DirectMedia Layer) through 2.0.12 has an Integer Overflow (and resultant SDL_memcpy heap corruption) in SDL_BlitCopy in video/SDL_blit_copy.c via a crafted .BMP file. | https://github.com/AlAIAL90/CVE-2020-14409 | 0 | 0| 
...
| 20210724T12:33:09Z | PoC for exploiting CVE-2020-36281 : Leptonica before 1.80.0 allows a heap-based buffer over-read in pixFewColorsOctcubeQuantMixed in colorquant1.c. | https://github.com/AlAIAL90/CVE-2020-36281 | 0 | 0| 
| 20210724T12:33:03Z | PoC for exploiting CVE-2021-28906 : In function read_yin_leaf() in libyang <= v1.0.225, it doesn%t check whether the value of retval->ext[r] is NULL. In some cases, it can be NULL, which leads to the operation of retval->ext[r]->flags that results in a crash. | https://github.com/AlAIAL90/CVE-2021-28906 | 0 | 0| 
