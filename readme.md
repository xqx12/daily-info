...
| --- | --- | --- | --- | ---| 
| 20210603T12:48:52Z | CVE-2021-27965 | PoC for CVE-2021-27965, stack buffer overflow in MsIo64.sys, LPE to nt authority/system | https://github.com/mathisvickie/CVE-2021-27965 | The MsIo64.sys driver before 1.1.19.1016 in MSI Dragon Center before 2.0.98.0 has a buffer overflow that allows privilege escalation via a crafted 0x80102040, 0x80102044, 0x80102050, or 0x80102054 IOCTL request.| 
