...
| ts | title | url | stars | forks| 
| --- | --- | --- | --- | ---| 
| 20210113T13:40:39Z | The Hybrid Fake Face (HFF) dataset is built by exploiting the PGGAN, StyleGAN, Glow, and StarGAN.  | https://github.com/EricGzq/Hybrid-Fake-Face-Dataset | 6 | 0| 
