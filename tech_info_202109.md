...
| 20210902 | 反向代理以及不同反向代理方案中错误配置导致的安全问题 | https://speakerdeck.com/greendog/2-and-a-bit-of-magic| 
| 20210902 | HITB 2021 新加坡安全会议的视频公开了 | https://www.youtube.com/playlist?list=PLmv8T5-GONwQhUlGN2UhOAi8YxPaiYCDQ| 
| 20210902 | 恶意软件 STASHLOG 利用 Windows CLFS Log 藏 Payload | https://www.fireeye.com/blog/threat-research/2021/09/unknown-actor-using-clfs-log-files-for-stealth.html| 
| 20210902 | CVE-2021-26084 Remote Code Execution on Confluence Servers | https://github.com/httpvoid/writeups/blob/main/Confluence-RCE.md| 
| 20210902 | LiquidSnake - 利用 WMI Event Subscriptions 实现 Windows 系统的无文件横向移动 | https://github.com/RiccardoAncarani/LiquidSnake| 
| 20210902 | 这篇 Paper 提出了一种称作 SGC 自动化寻找 ROP Gadget Chains 的通用方法 | https://www.syssec.ruhr-uni-bochum.de/media/emma/veroeffentlichungen/2021/08/16/GadgetSynthesis-ESORICS21.pdf| 
| 20210902 | 如何实现 Intel ATOM CPU 中的任意微码执行 | https://github.com/chip-red-pill/Sildes/blob/master/ZN2021/HOW_WE_ACHIEVED_TO_EXECUTE_uCODE.pdf| 
| 20210902 | 渗透测试中的 SSH 横向移动手册 | https://highon.coffee/blog/ssh-lateral-movement-cheat-sheet/| 
| 20210902 | HyperFuzzer - 利用 Intel PT 技术 Fuzz Microsoft Hyper-V | https://www.microsoft.com/en-us/research/publication/hyperfuzzer-an-efficient-hybrid-fuzzer-for-virtual-cpus/| 
...
| 20210902 | Nginx 场景绕过之二：斜杠(trailing slash) 与 编码 | https://github.com/CHYbeta/OddProxyDemo/blob/master/nginx/demo2/README.md| 
...
| 20210903T22:57:03Z | CVE-2021-1591 | PoC for exploiting CVE-2021-1591 : A vulnerability in the EtherChannel port subscription logic of Cisco Nexus 9500 Series Switches could allow an unauthenticated, remote attacker to bypass access control list (ACL) rules that are configured on an affected device. This vulnerability is due to oversubscription of resources that occurs when applying ACLs to port channel interfaces. An attacker could exploit this vulnerability by attempting to access network resources that are protected by the ACL. A successful exploit could allow the attacker to access network resources that would be protected by the ACL that was applied on the port channel interface. | https://github.com/AlAIAL90/CVE-2021-1591 | | 
...
| 20210903T22:56:37Z | CVE-2021-33007 | PoC for exploiting CVE-2021-33007 : A heap-based buffer overflow in Delta Electronics TPEditor: v1.98.06 and prior may be exploited by processing a specially crafted project file. Successful exploitation of this vulnerability may allow an attacker to execute arbitrary code. | https://github.com/AlAIAL90/CVE-2021-33007 | | 
...
| ts | title | url | stars | forks| 
| --- | --- | --- | --- | ---| 
| 20210904T01:41:48Z | blowing the whistle on the apparent %otax% discord exploit. | https://github.com/6x2/otax | 0 | 0| 
| 20210904T01:40:02Z | ROBLOX exploit scripts. | https://github.com/florian9721/Exploit-Scripts | 0 | 0| 
| 20210904T01:02:56Z | Open-Source Vulnerability Intelligence Center - Unified source of vulnerability, exploit and threat Intelligence feeds | https://github.com/Patrowl/PatrowlHearsData | 29 | 15| 
...
| ts | title | url | stars | forks| 
| --- | --- | --- | --- | ---| 
| 20210904T01:32:33Z | Null | https://github.com/ssllllll/Backdoored-Plugin | 0 | 0| 
...
| 20210902T13:52:54Z | A symbolic execution tool for Move, which is a smart contract language designed for Facebook Diem. | https://github.com/LEAFERx/Movable | 0 | 0| 
...
| 20210902T03:22:18Z | Triton is a Dynamic Binary Analysis (DBA) framework. It provides internal components like a Dynamic Symbolic Execution (DSE) engine, a dynamic taint engine, AST representations of the x86, x86-64, ARM32 and AArch64 Instructions Set Architecture (ISA), SMT simplification passes, an SMT solver interface and, the last but not least, Python bindings. | https://github.com/JonathanSalwan/Triton | 1882 | 391| 
