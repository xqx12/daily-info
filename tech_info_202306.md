...
| ts | title | url| 
| --- | --- | ---| 
| 20230610 | HTTP 网关 GZIP 页面零开销注入 JS | https://www.cnblogs.com/index-html/p/inject-js-into-a-gzipped-html-without-decompressing.html| 
| 20230610 | 黑盒 fuzz 工具 Jackalope 的使用 | https://paper.seebug.org/2070/| 
| 20230610 | Linux上文件监控的踩坑分享 | https://www.cnxct.com/linux-file-system-fsnotify-notes/| 
| 20230610 | TCP/UDP 端口复用器 | https://www.hedysx.com/2913.html| 
...
| ts | title | url | stars | forks| 
| --- | --- | --- | --- | ---| 
| 20230612T00:11:44Z | The BackDoor of HIPHP gives you the power to control websites based on PHP using HTTP/HTTPS protocol. By sending files, tokens and commands through port 80%s POST/GET method, users can access a range of activities such as downloading and editing files. It also allows for connecting to Tor networks with password protection for extra security. | https://github.com/yasserbdj96/hiphp | 111 | 24| 
...
| ts | title | url | stars | forks| 
| --- | --- | --- | --- | ---| 
| 20230610T15:55:00Z | DroneSecurity (NDSS 2023) | https://github.com/RUB-SysSec/DroneSecurity | 687 | 108| 
