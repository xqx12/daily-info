...
| ts | title | url | stars | forks| 
| --- | --- | --- | --- | ---| 
| 20240105T13:19:25Z | SSH-Snake is a self-propagating, self-replicating, file-less script that automates the post-exploitation task of SSH private key and host discovery. | https://github.com/MegaManSec/SSH-Snake | 63 | 4| 
