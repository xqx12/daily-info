...
| ts | title | url | stars | forks| 
| --- | --- | --- | --- | ---| 
| 20210217T01:22:26Z | Essa exploit localiza um número, retorna operadora é estado. | https://github.com/igorsouza60/locazila_numero | 0 | 0| 
...
| 20210217T00:50:06Z | 🔍NVD exploit & JVN(Japan Vulnerability Notes) easy description | https://github.com/nomi-sec/NVD-Exploit-List-Ja | 7 | 4| 
...
| ts | title | url | stars | forks| 
| --- | --- | --- | --- | ---| 
| 20210217T01:21:51Z | An AWS Pentesting tool that lets you use one-liner commands to backdoor an AWS account%s resources with a rogue AWS account - or share the resources with the entire internet 😈 | https://github.com/hirajanwin/endgame | 19 | 160| 
