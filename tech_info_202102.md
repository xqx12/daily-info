...
| ts | title | url | stars | forks| 
| --- | --- | --- | --- | ---| 
| 20210217T02:30:00Z | An AWS Pentesting tool that lets you use one-liner commands to backdoor an AWS account%s resources with a rogue AWS account - or share the resources with the entire internet 😈 | https://github.com/hirajanwin/endgame | 27 | 167| 
