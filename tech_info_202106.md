...
| ts | title | url | stars | forks| 
| --- | --- | --- | --- | ---| 
| 20210613T01:46:00Z | Script para usar el exploit de deteccion de vulnerabilidades de windows o dispositivos conectados (normalmente windows 7 o testeados) | https://github.com/zNetShell/script-nmap-ms17-010 | 0 | 0| 
