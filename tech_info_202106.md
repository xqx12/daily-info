...
| --- | --- | --- | --- | ---| 
| 20210630T12:39:34Z | CVE-2021-1675 | Impacket implementation of CVE-2021-1675 | https://github.com/cube0x0/CVE-2021-1675 | Windows Print Spooler Elevation of Privilege Vulnerability| 
...
| ts | title | url | stars | forks| 
| --- | --- | --- | --- | ---| 
| 20210630T12:41:34Z | Some Lua scripts I make, some might be useless, some might be useful. Some of these scripts may be Roblox only, and may require a Roblox exploit. | https://github.com/strawbberrys/LuaScripts | 0 | 1| 
