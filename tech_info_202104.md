...
| ts | title | url | stars | forks| 
| --- | --- | --- | --- | ---| 
| 20210413T00:22:20Z | Exploit allowing to load arbitrary code on the PSX using only a memory card (no game needed) | https://github.com/brad-lin/FreePSXBoot | 117 | 9| 
