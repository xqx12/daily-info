...
| ts | title | url | stars | forks| 
| --- | --- | --- | --- | ---| 
| 20210411T00:55:42Z | Exploit allowing to load arbitrary code on the PSX using only a memory card (no game needed) | https://github.com/brad-lin/FreePSXBoot | 40 | 2| 
