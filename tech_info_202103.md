...
| --- | --- | --- | --- | ---| 
| 20210316T12:43:34Z | CVE-2021-3156 | Sudo Baron Samedit Exploit | https://github.com/worawit/CVE-2021-3156 | Sudo before 1.9.5p2 has a Heap-based Buffer Overflow, allowing privilege escalation to root via %sudoedit -s% and a command-line argument that ends with a single backslash character.| 
...
| ts | title | url | stars | forks| 
| --- | --- | --- | --- | ---| 
| 20210316T12:44:36Z | Null | https://github.com/CyberCommands/exploit-sudoedit | 0 | 0| 
| 20210316T12:44:24Z | Exploiting the Unique Expression for Improved Sentiment Analysis in Software Engineering Text | https://github.com/huiAlex/SESSION | 0 | 0| 
